...
def get_params():
    ...
    parser.add_argument("-uc", "--uncertainty", type = float,
                       ...
                       to another and double this amount at terminal nodes",
                        default = None)
    parser.add_argument("-ti", "--tightness", type = int,
                       help = "Defines the minimum tightness at each node \
                       expected from the schedule generated by the scheduler",
                        default = Config.MIN_TIGHTNESS)
